...
class factory
{
	...
	{
		require_once(_CLASS_ROOT.'benchmark.class.php');
	...
	{
		require_once(_CLASS_ROOT.'tpl.class.php');
	...
	{
		require_once(_CLASS_ROOT._DB_TYPE.'.class.php');
		$db_type = _DB_TYPE;
	...
	{
		require_once(_CLASS_ROOT.'debug.class.php');
	...
	{
		require_once(_CLASS_ROOT.'nodebug.class.php');
		$nodebug = new nodebug();
		return $nodebug;
	}
	...
	{
		require_once(_CLASS_ROOT.'dbdebug.class.php');
		$dbdebug = new dbdebug();
		return $dbdebug;
	}
	...
	{
		require_once(_CLASS_ROOT.'encrypt.class.php');
		$encrypt = new encrypt();
		return $encrypt;
	}
	static public function & createInputObject()
	{
		require_once(_CLASS_ROOT.'input.class.php');
		$input = new input();
		return $input;
	}
	...
	{
		require_once(_CLASS_ROOT.'page.class.php');
	...
	{
		require_once(_CLASS_ROOT.'memc.class.php');
		$memc = new memc();
		return $memc;
	}
}
